    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-[2.5rem] font-bold text-[#1A237E] mb-4">Report Suspicious Activity</h1>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8 sm:p-12">
          <form onSubmit={handleSubmit}>
            <div className="space-y-8">
              ...
              <div>
                <label className="block text-lg font-medium text-gray-700 mb-2">Reason for reporting</label>
                  ...
                  {[
                    ...
                    return (
                      <div key={reason.value} className="relative">
                        ...
                        >
                          <Icon
                            className={`h-5 w-5 ${reportData.reason === reason.value ? "text-purple-700" : "text-gray-500"}`}
                          />
        ...
        <div className="mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="list-disc pl-5 space-y-2 text-blue-700">
            <li>We take user safety seriously. If someone&apos;s behavior is concerning, please let us know.</li>
            <li>We&apos;ll review your report carefully.</li>
            <li>Your identity won&apos;t be shared with the reported user.</li>
            <li>We&apos;ll take appropriate action as needed.</li>
          </ul>
        </div>
      </main>
